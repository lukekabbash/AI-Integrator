...
const INTEGRATOR_TOOL_COPY: Readonly<Record<string, readonly [string, string]>> = {
  ...
  browser_grant: ["Sharing a browser tab", "Shared a browser tab"],
  browser_focus: ["Bringing a tab forward", "Brought a tab forward"],
  browser_fill_login: ["Signing in", "Signed in"],
  browser_cookies: ["Checking cookies", "Checked cookies"],
